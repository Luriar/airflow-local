'''
- DAG 스케쥴은 하루에 한 번(00시00분00초) 지정하되 테스터는 트리거 작동
- T1 : S3에 특정위치에 적재된 데이터를 기반으로 테이블 구성
...
DATABASE_NAME = 'de-ai-12-an2-glue-db'
...
with DAG(
    ...
    t1 = AthenaOperator(
        ...
        STORED AS TEXTFILE
        LOCATION 's3://de-ai-12-827913617635-ap-northeast-2-an/csvs/'
